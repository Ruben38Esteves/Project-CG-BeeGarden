...
export class MyUnitCube extends CGFobject {
	...
	initBuffers() {
        ...
        this.texCoords = [
            0, 1, // 0 - lower back left
            1, 1, // 1 - lower back right
            1, 0, // 2 - lower front right
            0, 0, // 3 - lower front left
            0, 1, // 4 - upper back left
            1, 1, // 5 - upper back right
            1, 0, // 6 - upper front right
            0, 0, // 7 - upper front left
            0, 1, // 0 - lower back left
            1, 1, // 1 - lower back right
            1, 0, // 2 - lower front right
            0, 0, // 3 - lower front left
