...
export class MySphereBee extends CGFobject {
    constructor(scene, slices, stacks, radius, uScale = 1, vScale = 1) {
        super(scene);
        this.slices = slices;
        this.stacks = stacks;
        this.radius = radius;
    ...
    initBuffers() {
        ...
        for (let stack = 0; stack <= this.stacks; stack++) {
            ...
            for (let slice = 0; slice <= this.slices; slice++) {
                ...
                let u = slice / this.slices * this.uScale; // scale u
                let v = stack / this.stacks * this.vScale; // swapped u and v
